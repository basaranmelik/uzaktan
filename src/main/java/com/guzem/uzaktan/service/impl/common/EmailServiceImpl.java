...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendContactEmail(ContactRequest request) {
        String subject = "İletişim Formu: " + escapeHtmlBasic(request.getTopic());
    ...
    private String row(String label, String value) {
        return "<tr>" +
               ...
               "  white-space:nowrap;border-bottom:1px solid #e8edf3;width:35%;\">" + escapeHtmlBasic(label) + "</td>" +
               "<td style=\"padding:10px 16px;font-size:13px;color:#212529;" +
               "  border-bottom:1px solid #e8edf3;\">" + escapeHtmlBasic(value) + "</td>" +
               "</tr>";
    }
    ...
    private String escapeHtmlBasic(String text) {
        if (text == null) return "";
