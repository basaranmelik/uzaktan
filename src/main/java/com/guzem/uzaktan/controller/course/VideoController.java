...
public class VideoController {
    ...
    public String watchVideo(@PathVariable Long id,
        ...
        model.addAttribute("enrollment", enrollmentService.findByUserAndCourse(currentUserId, video.getCourseId()).orElse(null));
    ...
    public ResponseEntity<Map<String, Object>> recordProgress(@PathVariable Long id,
        ...
        courseVideoService.recordProgress(id, currentUserId, req);
